...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/lybot/AdvanDiptera_VIO/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/lybot/AdvanDiptera_VIO/devel/.private/amcl)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/lybot/AdvanDiptera_VIO/install)
...
if(NOT "/home/lybot/AdvanDiptera_VIO/devel/.private/amcl/include;/home/lybot/AdvanDiptera_VIO/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/lybot/AdvanDiptera_VIO/devel/.private/amcl/include;/home/lybot/AdvanDiptera_VIO/src/navigation/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/AdvanDiptera_VIO/src/navigation/amcl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/AdvanDiptera_VIO/devel/.private/amcl/lib;/home/lybot/AdvanDiptera_VIO/devel/lib;/home/lybot/vio_ws/devel/lib;/opt/ros/melodic/lib)
