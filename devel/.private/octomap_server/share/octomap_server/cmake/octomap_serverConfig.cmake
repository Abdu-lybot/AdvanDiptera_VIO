...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/lybot/AdvanDiptera_VIO/src/octomap_mapping/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/lybot/AdvanDiptera_VIO/devel/.private/octomap_server)
  ...
  set(octomap_server_INSTALL_PREFIX /home/lybot/AdvanDiptera_VIO/install)
...
if(NOT "/home/lybot/AdvanDiptera_VIO/devel/.private/octomap_server/include;/home/lybot/AdvanDiptera_VIO/src/octomap_mapping/octomap_server/include;/opt/ros/melodic/include " STREQUAL " ")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/lybot/AdvanDiptera_VIO/devel/.private/octomap_server/include;/home/lybot/AdvanDiptera_VIO/src/octomap_mapping/octomap_server/include;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/AdvanDiptera_VIO/src/octomap_mapping/octomap_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/AdvanDiptera_VIO/devel/.private/octomap_server/lib;/home/lybot/AdvanDiptera_VIO/devel/lib;/home/lybot/vio_ws/devel/lib;/opt/ros/melodic/lib)
