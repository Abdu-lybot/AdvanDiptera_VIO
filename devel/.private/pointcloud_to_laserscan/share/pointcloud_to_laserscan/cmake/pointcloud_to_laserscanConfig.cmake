...
if("TRUE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /home/lybot/AdvanDiptera_VIO/src/pointcloud_to_laserscan-lunar-devel)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /home/lybot/AdvanDiptera_VIO/devel/.private/pointcloud_to_laserscan)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /home/lybot/AdvanDiptera_VIO/install)
...
if(NOT "/home/lybot/AdvanDiptera_VIO/src/pointcloud_to_laserscan-lunar-devel/include " STREQUAL " ")
  set(pointcloud_to_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/lybot/AdvanDiptera_VIO/src/pointcloud_to_laserscan-lunar-devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/AdvanDiptera_VIO/src/pointcloud_to_laserscan-lunar-devel/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/AdvanDiptera_VIO/devel/.private/pointcloud_to_laserscan/lib;/home/lybot/AdvanDiptera_VIO/devel/lib;/home/lybot/vio_ws/devel/lib;/opt/ros/melodic/lib)
