...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/lybot/AdvanDiptera_VIO/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/lybot/AdvanDiptera_VIO/devel/.private/rotate_recovery)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/lybot/AdvanDiptera_VIO/install)
...
if(NOT "/home/lybot/AdvanDiptera_VIO/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/lybot/AdvanDiptera_VIO/src/navigation/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/AdvanDiptera_VIO/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/AdvanDiptera_VIO/devel/.private/rotate_recovery/lib;/home/lybot/AdvanDiptera_VIO/devel/lib;/home/lybot/vio_ws/devel/lib;/opt/ros/melodic/lib)
