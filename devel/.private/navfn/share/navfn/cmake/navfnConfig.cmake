...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/lybot/AdvanDiptera_VIO/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/lybot/AdvanDiptera_VIO/devel/.private/navfn)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/lybot/AdvanDiptera_VIO/install)
...
if(NOT "/home/lybot/AdvanDiptera_VIO/devel/.private/navfn/include;/home/lybot/AdvanDiptera_VIO/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/lybot/AdvanDiptera_VIO/devel/.private/navfn/include;/home/lybot/AdvanDiptera_VIO/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lybot/AdvanDiptera_VIO/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lybot/AdvanDiptera_VIO/devel/.private/navfn/lib;/home/lybot/AdvanDiptera_VIO/devel/lib;/home/lybot/vio_ws/devel/lib;/opt/ros/melodic/lib)
